    ...
    <div class="wrap">
      <div class="flex_between">
        ...
        <div class="medical_courses">
          ...
          <p class="course_naiyou">「歯周病」とは、歯垢（プラーク）の中の細菌によって歯肉に炎症をひき起こし、やがては歯を支えている骨を溶かしていく炎症性疾患のことです。</p>
  ...
  <div class="background_color">
    ...
    <div class="wrap">
      ...
      <p class="margin-top padding-bottom">
        患者様の歯に関するお悩みをしっかりとすべてお聞かせいただき、患者様各々に最適な治療法を提供させていただきます。痛くない治療をご希望の方、短期集中型で治療したい方など、ご希望がございましたら遠慮なくお申しつけください。けいびる歯科医院が、あなたの歯のお悩みを解決します。
